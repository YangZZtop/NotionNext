...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '五条薯条', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个想退休的摆烂人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-jet-six-22.vercel.app', // 网站地址
